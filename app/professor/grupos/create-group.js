...
export default function CreateGroup() {
  ...
  async function criarGrupo() {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/grupos-treino`, {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        Alert.alert("Erro", data.error || data.message || "Erro ao cadastrar grupo.");
        return;
      }

      Alert.alert("Sucesso", "Grupo de treino cadastrado com sucesso!");
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Cadastre um novo grupo de treino</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          >
            {loading ? (
              ...
              <Text style={styles.submitButtonText}>Cadastrar Grupo</Text>
            )}
          </TouchableOpacity>
